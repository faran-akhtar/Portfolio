                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-content text-center">
                            <!-- <h2 class="text-white text-uppercase mb-3", style="color: white;">What we offer</h2> -->
                            <h2 class="servicecolor" style="color: white;">What we offer</h2>
        ...
        <!-- ***** Service Area End ***** -->
         ...
         <section id="service" class="section service-area ptb_150">
            ...
            <div class="shape shape-top">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none" fill="gold">
