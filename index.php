<?php include "header.php"; ?>
        <!-- ***** Welcome Area Start ***** -->
        <section id="home" class="section welcome-area overlay-dark overflow-hidden d-flex align-items-center">
            <div class="container">
...
?>
            ...
            <div class="shape shape-bottom">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none" fill="gray">
...
?>
        ...
        <section id="service" class="section service-area bg-grey ptb_150">
            ...
            <div class="shape shape-top">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none" fill="black">
                    <path class="shape-fill" d="M421.9,6.5c22.6-2.5,51.5,0.4,75.5,5.3c23.6,4.9,70.9,23.5,100.5,35.7c75.8,32.2,133.7,44.5,192.6,49.7
                c23.6,2.1,48.7,3.5,103.4-2.5c54.7-6,106.2-25.6,106.2-25.6V0H0v30.3c0,0,72,32.6,158.4,30.5c39.2-0.7,92.8-6.7,134-22.4
                c21.2-8.1,52.2-18.2,79.7-24.2C399.3,7.9,411.6,7.5,421.9,6.5z"></path>
                </svg>
...
<!-- Single Service -->
<div class='single-service p-4'  style='border: solid 1px black;'>
        ...
        <section id="contact" class="contact-area  ptb_100">
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-12 col-lg-6 pt-4 pt-lg-0 overlay-dark">
                        <!-- Contact Box -->
                        <div class="contact-box text-center overlay-dark">
                            <!-- Contact Form -->
                            <?php
...
<form action="" method="post" enctype="multipart/form-data">
        ...
        <section class="section cta-area overlay-dark ptb_100">
            <div class="container overlay-dark">
                <div class="row justify-content-center">
